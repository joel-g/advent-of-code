...
class day2 {
  ...
  public static void main (String[] args) {
    ...
    int[][] nums = {{1364,	461,	1438,	1456,	818, 999,	105,	1065,	314,	99,	1353,	148,	837,	590, 404,	123},
    ...
    for (int[] t: nums) {
      result = result + difference(t);  
    }

    for (int[] t: nums) {
      secondResult = secondResult + divisible(t);
    }
