nums = [[1364,	461,	1438,	1456,	818, 999,	105,	1065,	314,	99,	1353,	148,	837,	590, 404,	123],
...
function checkSum(nums) {
    const diffs = nums.map(row => Math.max(...row) - Math.min(...row))
    sum = 0;
    for (const num of diffs) { sum += num }
    return sum;
}
